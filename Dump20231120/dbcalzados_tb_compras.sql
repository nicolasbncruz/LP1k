...
CREATE TABLE `tb_compras` (
  ...
  `prv_cantidad` int DEFAULT NULL,
  `pr_costo` decimal(12,2) DEFAULT NULL,
  `fecha` datetime DEFAULT NULL,
  PRIMARY KEY (`idCompras`),
  KEY `idProducto_idx` (`idProducto`),
  KEY `idProveedor_idx` (`idProveedor`),
  CONSTRAINT `idProducto` FOREIGN KEY (`idProducto`) REFERENCES `tb_productos` (`idProducto`),
  CONSTRAINT `idProveedor` FOREIGN KEY (`idProveedor`) REFERENCES `tb_proveedores` (`idProveedores`)
